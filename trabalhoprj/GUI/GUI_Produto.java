...
public class GUI_Produto extends javax.swing.JDialog {
     ...
     */
    public GUI_Produto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(edFiltro, javax.swing.GroupLayout.PREFERRED_SIZE, 394, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    if (JanelaProduto.executar(null, OperacaoCadastro.ocIncluir, produto)){
    ...
    int index = tabProduto.getSelectedRow();
    if (index >= 0){
        Produto produto = modeloProduto.obterProduto(index);
        if (JanelaProduto.executar(null, OperacaoCadastro.ocAlterar, produto)){
            modeloProduto.atualizarProduto(index, produto);
            }
        }
    ...
    if (index >= 0){
        ...
        if (Resposta == JOptionPane.YES_OPTION) {
            Produto produto = modeloProduto.obterProduto(index);
            modeloProduto.excluirProduto(index, produto);
            }
        }
    ...
    private void buSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buSelecionarActionPerformed
        ...
        if (index >= 0){
            Produto produto = modeloProduto.obterProduto(index);
            JanelaProduto.executar(null, OperacaoCadastro.ocConsultar, produto);
        }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        if (modeloProduto.getRowCount() >= 0) {
            modeloProduto.carregar();
        }
    }//GEN-LAST:event_formWindowOpened

    private void buBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buBuscarActionPerformed
        tableRowSorter = new TableRowSorter(modeloProduto);
        tableRowSorter.setRowFilter(RowFilter.regexFilter( "(?i)" + edFiltro.getText(),0,1,2,3,4));
        tabProduto.setRowSorter(tableRowSorter);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_Produto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GUI_Produto dialog = new GUI_Produto(new javax.swing.JFrame(), true);
